...
class FilteredProductsScren extends StatefulWidget {
  const FilteredProductsScren(
      {Key? key, required this.startDate, required this.endDate})
      : super(key: key);
  final startDate, endDate;
  @override
  State<FilteredProductsScren> createState() => _FilteredProductsScrenState();
}

class _FilteredProductsScrenState extends State<FilteredProductsScren> {
  @override
        ...
        body: Column(
          children: [
            Expanded(
              ...
              future: SaleService.getFilteredProductsNames(
                  widget.startDate, widget.endDate),
              builder: (context, snapshot) {
                if (snapshot.hasData) {
                  return FutureBuilder<dynamic>(
                    future: SaleService.getFilteredProductsCounts(
                        widget.startDate, widget.endDate),
